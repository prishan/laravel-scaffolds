...
namespace Prishan\LaravelScaffolds\DependentClasses\Rapyd\Field;

use Illuminate\Html\FormFacade as Form;
use Zofe\Rapyd\Rapyd;
use Zofe\Rapyd\DataForm\Field\Field;

class DateValidated extends Field
{
    public $type = "date";
    public $format = 'm/d/Y';
    public $language = 'en';
            ...
            case "modify":
                ...
                Rapyd::script("
                        $('#".$this->name."').datepicker({
                            ...
                            $('#".$this->name."').valid();  // triggers the validation test on change
                        });");
